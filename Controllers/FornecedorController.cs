...
namespace ProjetoMercado.Controllers
{
    public class FornecedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FornecedorId,NomeFornecedor,CNPJFornecedor")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FornecedorId,NomeFornecedor,CNPJFornecedor")] Fornecedor fornecedor)
        {
