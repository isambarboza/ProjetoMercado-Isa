...
namespace ProjetoMercado.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,NomeProduto,PrecoProduto,QntEstoqueProduto,NumeroDoCodigo,IdCategoria,IdFornecedor")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutoId,NomeProduto,PrecoProduto,QntEstoqueProduto,NumeroDoCodigo,IdCategoria,IdFornecedor")] Produto produto)
        {
